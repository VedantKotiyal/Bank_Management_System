...
public class signup3 extends JFrame implements ActionListener{
    ...
    signup3(String formno){
        ...
        l6 = new JLabel("It would appear on Debit Card/Cheque Book and Statements");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        try{
            ...
            {
                con c1=new con();
                c1.s.executeUpdate("delete from signup1 where FormNumber= '"+Integer.parseInt(formno)+"'");
                c1.s.executeUpdate("delete from signup2 where FormNumber= '"+Integer.parseInt(formno)+"'");
                System.exit(0);
            }
            if(!c7.isSelected())
